...
interface UserCredentialRepository : JpaRepository<UserCredential, Long> {
    ...
    fun findFirstByUsernameAndTypeAndUserDeletedAtIsNull(username: String, type: String): UserCredential?
    ...
    fun findFirstByUsernameAndTypeAndUserDeletedAtIsNullOrThrow(username: String, type: String): UserCredential {
