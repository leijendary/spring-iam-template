package com.leijendary.spring.iamtemplate.log;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.leijendary.spring.iamtemplate..*.*(..))")
    public void includedPointcut() {}

    @Pointcut(
            "execution(* com.leijendary.spring.iamtemplate.config..*.*(..)) || " +
            "execution(* com.leijendary.spring.iamtemplate.filter..*.*(..)) || " +
            "execution(* com.leijendary.spring.iamtemplate.log..*.*(..)) || " +
            "execution(* com.leijendary.spring.iamtemplate.Application..*(..))")
